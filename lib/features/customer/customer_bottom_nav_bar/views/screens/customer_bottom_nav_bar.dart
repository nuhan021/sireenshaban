...
import 'package:sireenshaban/core/common/widgets/guest_login_prompt.dart';
...
class CustomerBottomNavBar extends StatelessWidget {
  ...
  List<Widget> _buildScreens() {
    ...
    return [
      ...
      EventsScreen(),
      isGuest
          ? const Scaffold(body: GuestLoginPrompt(message: 'Log in to chat with service providers'))
          : ChatListScreen(),
      isGuest
          ? const Scaffold(body: GuestLoginPrompt(message: 'Log in to view your profile'))
          : ProfileScreen(),
    ];
  }
  ...
  List<PersistentTabConfig> _tabs() => [
    PersistentTabConfig(
      ...
      item: ItemConfig(
        ...
        title: "Home",
        textStyle: getTextStyle(fontSize: 10, fontWeight: FontWeight.w500),
  ...
  Widget build(BuildContext context) {
    return PersistentTabView(
      ...
      navBarBuilder: (navBarConfig) =>
          Style1BottomNavBar(navBarConfig: navBarConfig, height: 70),
      onTabChanged: (index) {
